...
class Player:
    ...
    def position_ship(self, start_pos, finish_pos):
        # START
        letter_start = start_pos[0].upper()
        number_start = start_pos[1:]
        row_start = int("".join(number_start)) - 1
    ...
    def setup_board(self):
        ...
        for length in ships_lengths:
            ...
            finishing_block = input()
            print(str(length) + " block ship position -> " + starting_block + ":" + finishing_block)
            self.position_ship(str(starting_block), str(finishing_block))
...
class Computer:
    ...
    def setup_board(self):
        self.position_ship(2)
        self.position_ship(3)
        self.position_ship(4)
        self.position_ship(5)
